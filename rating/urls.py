...
from rating.filters import SubjectFilter

app_name = 'rating'
urlpatterns = [
    path('', views.index, name='index'),
    path('search', FilterView.as_view(filterset_class=SubjectFilter, template_name='rating/search_subject.html'),
         name='search'),
    ...
    path('activate_subject', views.ActivateSubjectView.as_view(), name='activate_subject'),
]
